...
@Component({
  ...
  template: `
    <!-- SIDEBAR -->
  <aside
  class="fixed md:static z-40 w-64 min-h-screen p-6
...
>
  ...
  <!-- Logo y título -->
  <div>
    <h1 class="text-2xl font-bold mb-1 text-gray-900 dark:text-white">ISP Admin</h1>
    <p class="text-sm text-gray-500 dark:text-gray-400 mb-8">Panel de Control</p>
    ...
    <nav class="space-y-4">
      ...
      <div class="uppercase text-xs text-gray-400 dark:text-gray-500 font-semibold mt-6 mb-2">
        Administración
      </div>
